...
// 隐藏侧边
function hiddenwidget(obj) {
    var me = $(obj);
    // 获取相邻图标
    var obj_i = me.parent().find('i');
    // alert(obj_i.attr('class'));
    // alert(me.attr('title'));
    var R = document.getElementById("sidebar");
    var L = document.getElementById("primary");
    if ( R.className=="sidebar" ) {
        // 显示侧边栏操作
        obj_i.removeClass('icon-magnifyminus').addClass('icon-magnifyplus');
        me.attr('title', '隐藏侧边栏');
        ...
        // 隐藏侧边栏操作
        me.attr('title', '显示侧边栏');
        obj_i.removeClass('icon-magnifyplus').addClass('icon-magnifyminus');
        R.className="sidebar";
        L.className="primary";
    }
}
