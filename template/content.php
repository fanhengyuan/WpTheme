<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>			
	<?php if ( ! is_single() ) : ?>
		...
		<div class="art_ft">
			<div class="art-pub">
				<div class="views">
					<i class="iconfont icon-linux1"></i> <?php if( function_exists( 'the_views' ) ) { the_views(); } ?>
				</div>
			...
			<div class="art-info">
				...
				<span class="data" title="<?php echo date('Y.m.d H:i:s', get_the_time('U'));?>"><i class="iconfont icon-calendartext"></i> <?php echo date('Y-m-d',get_the_time('U'));?></span>
	...
	<?php if ( is_single() ) : ?>	
		<header class="entry-header">							
			<div class="single-meta">				
				<span title="<?php echo date('Y.m.d H:i:s', get_the_time('U'));?>"><i class="iconfont icon-calendartext"></i>&nbsp;<?php echo date('Y-m-d',get_the_time('U'));?></span>
				<span><i class="iconfont icon-linux1"></i>&nbsp;<?php if( function_exists( 'the_views' ) ) { the_views(); } ?></span>	
