...
query_posts($args);
if(have_posts()):while (have_posts()&&$i<=$pic_num) : the_post(); update_post_caches($posts); ?>
    <div class="r4">
...
<?php if($i<=$pic_num){?>
<?php query_posts('showposts=8&orderby=rand');while(have_posts()&&$i<=$pic_num):the_post(); ?>
    <div class="r4">
        <div class="related-site">
        <figure class="related-site-img">
            <?php get_thumbnail(300,180) ?>
